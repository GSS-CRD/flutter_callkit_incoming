...
class CallkitIncomingBroadcastReceiver : BroadcastReceiver() {
        ...
        when (action) {
            "${context.packageName}.${CallkitConstants.ACTION_CALL_INCOMING}" -> {
                try {
                    ...
                    sendEventCordova(CallkitConstants.ACTION_CALL_INCOMING, data)
            ...
            "${context.packageName}.${CallkitConstants.ACTION_CALL_START}" -> {
                try {
                    sendEventCordova(CallkitConstants.ACTION_CALL_START, data)
            ...
            "${context.packageName}.${CallkitConstants.ACTION_CALL_ACCEPT}" -> {
                try {
                    sendEventCordova(CallkitConstants.ACTION_CALL_ACCEPT, data)
            ...
            "${context.packageName}.${CallkitConstants.ACTION_CALL_DECLINE}" -> {
                try {
                    sendEventCordova(CallkitConstants.ACTION_CALL_DECLINE, data)
                    context.stopService(Intent(context, CallkitSoundPlayerService::class.java))
            ...
            "${context.packageName}.${CallkitConstants.ACTION_CALL_ENDED}" -> {
                try {
                    sendEventCordova(CallkitConstants.ACTION_CALL_ENDED, data)
                    context.stopService(Intent(context, CallkitSoundPlayerService::class.java))
                    callkitNotificationManager.clearIncomingNotification(data, false)
                    removeCall(context, Data.fromBundle(data))
                } catch (error: Exception) {
            ...
            "${context.packageName}.${CallkitConstants.ACTION_CALL_TIMEOUT}" -> {
                try {
                    sendEventCordova(CallkitConstants.ACTION_CALL_TIMEOUT, data)
                    context.stopService(Intent(context, CallkitSoundPlayerService::class.java))
            ...
            "${context.packageName}.${CallkitConstants.ACTION_CALL_CALLBACK}" -> {
                try {
                    ...
                    sendEventCordova(CallkitConstants.ACTION_CALL_CALLBACK, data)
    ...
    private fun sendEventCordova(event: String, data: Bundle) {
        val android = mapOf(
        ...
        CordovaCallkitIncomingPlugin.sendEvent(event, forwardData)
    }
}