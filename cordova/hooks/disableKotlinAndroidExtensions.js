module.exports = function(context) {
  ...
  // Check if the 'kotlin-android-extensions' plugin is applied and not commented
  if (content.includes("apply plugin: 'kotlin-android-extensions'") && !content.includes("// apply plugin: 'kotlin-android-extensions'")) {
    // Comment the 'kotlin-android-extensions' plugin
